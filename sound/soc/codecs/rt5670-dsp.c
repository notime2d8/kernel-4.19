...
static unsigned short rt5670_dsp_init[][2] = {
	...
	{0x22c4, 0x1007}, {0x22fc, 0x6000}, {0x232b, 0x0090}
};
...
static unsigned short rt5670_dsp_16[][2] = {
	{0x22f2, 0x0058}, {0x2301, 0x0002}, {0x22ec, 0x8000} // 20150312 higher sample rate
};
...
static unsigned short rt5670_dsp_48k_sto_ffp[][2] = {
	...
	{0x23ab, 0x7c00}, {0x2393, 0x8765}, {0x239c, 0x7000}, {0x22fb, 0x0000}
};
...
static unsigned short rt5670_dsp_aec_handsfree[][2] = {
	...
	{0x23a3, 0x4000}, {0x23ad, 0x2000}, {0x23ae, 0x2000}, {0x23af, 0x2000},
	{0x23b4, 0x2000}, {0x23b5, 0x2000}, {0x23b6, 0x2000}, {0x23bb, 0x6000},
	{0x2303, 0x0710}, {0x2304, 0x0332}, {0x230c, 0x0b00}, {0x230d, 0x0080},
	{0x2310, 0x0010}, {0x2393, 0x8765}, {0x22fb, 0x0000}
};
 ...
 * Returns 0 for success or negative error code.
 */
static int rt5670_dsp_do_patch(struct snd_soc_component *component, int mode)
{
	int ret, i;
	struct rt5670_priv *rt5670 = snd_soc_component_get_drvdata(component);
	...
	case 0: /*Init*/
		for (i = 0; i < RT5670_DSP_INIT_PATCH_NUM; i++) {
			ret = snd_soc_component_write(component, rt5670_dsp_init_patch_code[i][0],
	...
	case 1: /*Reset*/
		for (i = 0; i < RT5670_DSP_RESET_PATCH_NUM; i++) {
			ret = snd_soc_component_write(component, rt5670_dsp_reset_patch_code[i][0],
...
static int rt5670_dsp_snd_effect(struct snd_soc_component *component)
{
	...
	if (!rt5670->dsp_inited) {
		ret = rt5670_dsp_do_patch(component, 0);
		if (ret < 0)
			goto effect_err;
		rt5670->dsp_inited = true;
	}

	ret = rt5670_dsp_do_patch(component, 1);
	if (ret < 0)
		goto effect_err;
	...
	ret = rt5670_dsp_rate(component,
		rt5670->sysclk ?
		rt5670->sysclk : 12288000, rate);
	//ret = rt5670_dsp_rate(component, 12288000, rate);
	if (ret < 0)
		goto effect_err;
...
int rt5670_dsp_probe(struct snd_soc_component *component)
{
	...
	mdelay(10);
		...
		if (rt5670_dsp_do_patch(component, 0) < 0)
			dev_err(component->dev, "Patch DSP rom code Fail !!!\n");

       //rt5670_dsp_rate(component, 24576000, 16000);
	   //rt5670_dsp_rate(component, 12288000, 16000);
		rt5670_dsp_rate(component, 12288000, 48000); //zzf
		rt5670_dsp_conf(component);
	rt5670_dsp_write(component, 0x22fb, 0);
	/* power down DSP*/
		mdelay(15);
	rt5670_dsp_write(component, 0x22f9, 1);
#endif
	...
	pr_err("%s(%d) DBG\n", __func__, __LINE__);
	 snd_soc_add_component_controls(component, rt5670_dsp_snd_controls,
	...
	request_firmware_nowait(THIS_MODULE, FW_ACTION_HOTPLUG,
				"rt567x_dsp.bin", component->dev, GFP_KERNEL,
				component, rt5670_dsp_fw_loaded);
	...
	struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	dev_dbg(component->dev, "rt_codec.number=%d\n", (int)rt_codec.number);
	...
	ret = snd_soc_component_update_bits(component, RT5670_PWR_DIG2,
		RT5670_PWR_I2S_DSP, RT5670_PWR_I2S_DSP);
	if (ret < 0) {
		dev_err(component->dev,
	...
	case RT_READ_CODEC_DSP_IOCTL:
		for (p = buf; p < buf + rt_codec.number / 2; p++)
			*(p + rt_codec.number / 2) = rt5670_dsp_read(component, *p);
	...
	case RT_WRITE_CODEC_DSP_IOCTL:
		if (component == NULL) {
			dev_dbg(component->dev, "component is null\n");
			break;
		}
		for (p = buf; p < buf + rt_codec.number / 2; p++)
			rt5670_dsp_write(component, *p, *(p + rt_codec.number / 2));
		break;
	...
	default:
		dev_info(component->dev, "unsported dsp command\n");
		break;
	}
